...
const Book = require('../models/Book') // importa o modelo dos livros Book
const router = express.Router(); // cria o elemento para rotear com base nas 

// Cria rota do post
//async é por conta que a requisicao tem um certo tempo para retornar
...
router.put('/:id', async(req,res)=>{
    const {title, author, year} = req.body; //extrai o conteudo da requisicao
try{
...
// delete - deleta o elemento pelo id
